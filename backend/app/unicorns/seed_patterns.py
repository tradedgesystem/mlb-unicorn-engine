...
CORE_RAW_COUNT_PATTERNS: List[dict] = [
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} barrels in the last 50 AB.",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} balls hit 100+ mph in the last 50 AB.",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} balls hit 105+ mph in the last 50 AB.",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} balls hit 110+ mph in the last 50 AB.",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} balls hit 95+ mph in the last 50 AB.",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} balls hit 90+ mph in the last 50 AB.",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} balls hit 100+ mph with an 8–32° launch angle in the last 50 AB.",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} balls hit 98+ mph with a 20–35° launch angle in the last 50 AB.",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} hard-hit air balls (95+ mph, 10°+ launch angle) in the last 50 AB.",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} pulled hard-hit air balls (95+ mph, 10–35° launch angle) in the last 50 AB.",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: barrel rate leader with {{metric_value}} barrels in the last 50 AB.",
        metric_expr=_sum_case(BARREL_COND),
        order_direction="desc",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: lowest barrel rate with {{metric_value}} barrels in the last 50 AB.",
        metric_expr=_sum_case(BARREL_COND),
        order_direction="asc",
        order_expr=RATE_ORDER_EXPR,
        min_sample=10,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: hard-hit rate leader with {{metric_value}} hard-hit balls (95+ mph) in the last 50 AB.",
        metric_expr=_sum_case("launch_speed >= 95"),
        order_direction="desc",
        order_expr=RATE_ORDER_EXPR,
        min_sample=10,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: lowest hard-hit rate with {{metric_value}} hard-hit balls (95+ mph) in the last 50 AB.",
        metric_expr=_sum_case("launch_speed >= 95"),
        order_direction="asc",
        order_expr=RATE_ORDER_EXPR,
        min_sample=10,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: 100+ mph rate leader with {{metric_value}} balls hit 100+ mph in the last 50 AB.",
        metric_expr=_sum_case("launch_speed >= 100"),
        order_direction="desc",
        order_expr=RATE_ORDER_EXPR,
        min_sample=10,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: lowest 100+ mph rate with {{metric_value}} balls hit 100+ mph in the last 50 AB.",
        metric_expr=_sum_case("launch_speed >= 100"),
        order_direction="asc",
        order_expr=RATE_ORDER_EXPR,
        min_sample=10,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: barrel rate vs 95+ mph fastballs: {{metric_value}} barrels (last 50 AB).",
        metric_expr=_sum_case(BARREL_COND),
        order_direction="desc",
        order_expr=RATE_ORDER_EXPR,
        min_sample=5,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} barrels vs 95+ mph fastballs (last 50 AB).",
        metric_expr=_sum_case(BARREL_COND),
        order_direction="desc",
        min_sample=5,
        complexity_score=3,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} balls hit 100+ mph vs 95+ mph fastballs (last 50 AB).",
        metric_expr=_sum_case("launch_speed >= 100"),
        order_direction="desc",
        min_sample=5,
        complexity_score=3,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: average exit velocity vs 95+ mph fastballs = {{metric_value}} mph (last 50 AB).",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: barrel rate vs breaking balls: {{metric_value}} barrels (last 50 AB).",
        metric_expr=_sum_case(BARREL_COND),
        order_direction="desc",
        order_expr=RATE_ORDER_EXPR,
        min_sample=5,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} barrels vs breaking balls (last 50 AB).",
        metric_expr=_sum_case(BARREL_COND),
        order_direction="desc",
        min_sample=5,
        complexity_score=2,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} balls hit 100+ mph vs breaking balls (last 50 AB).",
        metric_expr=_sum_case("launch_speed >= 100"),
        order_direction="desc",
        min_sample=5,
        complexity_score=2,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: average exit velocity vs breaking balls = {{metric_value}} mph (last 50 AB).",
        metric_expr="AVG(launch_speed)",
        order_direction="desc",
        min_sample=5,
        complexity_score=1,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: barrel rate vs offspeed pitches: {{metric_value}} barrels (last 50 AB).",
        metric_expr=_sum_case(BARREL_COND),
        order_direction="desc",
        order_expr=RATE_ORDER_EXPR,
        min_sample=5,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} barrels vs offspeed pitches (last 50 AB).",
        metric_expr=_sum_case(BARREL_COND),
        order_direction="desc",
        min_sample=5,
        complexity_score=2,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} balls hit 100+ mph vs offspeed pitches (last 50 AB).",
        metric_expr=_sum_case("launch_speed >= 100"),
        order_direction="desc",
        min_sample=5,
        complexity_score=2,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: average exit velocity vs offspeed pitches = {{metric_value}} mph (last 50 AB).",
        metric_expr="AVG(launch_speed)",
        order_direction="desc",
        min_sample=5,
        complexity_score=1,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} pulled-air barrels (last 50 AB).",
        metric_expr=_sum_case(BARREL_COND),
        order_direction="desc",
        min_sample=5,
        complexity_score=3,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: pulled-air barrel rate leader with {{metric_value}} barrels (last 50 AB).",
        metric_expr=_sum_case(BARREL_COND),
        order_direction="desc",
        order_expr=RATE_ORDER_EXPR,
        min_sample=5,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} pulled hard-hit air balls (95+ mph, 10°+ launch angle) in the last 50 AB.",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: pulled hard-air share with {{metric_value}} pulled hard-hit air balls in the last 50 AB.",
        metric_expr=_sum_case("hit_direction = 'pull' AND launch_speed >= 95 AND launch_angle >= 10"),
        order_direction="desc",
        order_expr=RATE_ORDER_EXPR,
        min_sample=10,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} pulled balls hit 98+ mph with a 20–35° launch angle in the last 50 AB.",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} air barrels (10°+ launch angle) in the last 50 AB.",
        metric_expr=_sum_case(BARREL_COND),
        order_direction="desc",
        min_sample=5,
        complexity_score=2,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: air barrel rate leader with {{metric_value}} barrels in the last 50 AB.",
        metric_expr=_sum_case(BARREL_COND),
        order_direction="desc",
        order_expr=RATE_ORDER_EXPR,
        min_sample=5,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: hard-hit air rate leader with {{metric_value}} hard-hit air balls (95+ mph, 10°+ launch angle) in the last 50 AB.",
        metric_expr=_sum_case("launch_speed >= 95"),
        order_direction="desc",
        order_expr=RATE_ORDER_EXPR,
        min_sample=5,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: average exit velocity on air balls = {{metric_value}} mph (last 50 AB).",
        metric_expr="AVG(launch_speed)",
        order_direction="desc",
        min_sample=5,
        complexity_score=1,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: ΔBarrels = {{metric_value}} over the last 50 AB.",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: Δ100+ = {{metric_value}} over the last 50 AB.",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: ΔHardHit = {{metric_value}} over the last 50 AB.",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: ΔPulledHardAir = {{metric_value}} over the last 50 AB.",
        metric_expr=_surge_expr(
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} weak-contact balls (under 80 mph) in the last 50 AB.",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} soft air balls (under 90 mph, 10°+ launch angle) in the last 50 AB.",
        metric_expr=_sum_case("launch_speed < 90"),
        order_direction="asc",
        order_expr=RATE_ORDER_EXPR,
        min_sample=5,
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: {{metric_value}} pop-ups in the last 50 AB.",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: max exit velocity = {{metric_value}} mph (last 50 AB).",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: second-highest exit velocity = {{metric_value}} mph (last 50 AB).",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: current 95+ mph batted-ball streak = {{metric_value}} games.",
        base_table="pa_facts",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: games with at least one barrel = {{metric_value}} (last 50 AB).",
    ...
    _core_hitter_pattern(
        ...
        description_template="{{player_name}}: barrels in the last 7 days = {{metric_value}}.",
        metric_expr=_sum_case(BARREL_COND),
        order_direction="desc",
        min_sample=5,
        complexity_score=1,
